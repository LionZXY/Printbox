package ru.lionzxy.printbox.utils.codec;
...
public class Base64InputStream extends FilterInputStream {
     ...
     */
    public Base64InputStream(InputStream in, boolean doEncode, boolean urlSafe) {
        super(in);
        this.doEncode = doEncode;
        this.base64 = new Base64(0, Base64.CHUNK_SEPARATOR, false);
    }
    ...
    /**
     * Attempts to read <code>len bytes into the specified b array starting at offset
